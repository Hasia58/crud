    ...
    <div class="container">
        <div class="justify-content-center row mt-4">
            <div class="d-flex col-md-10 justify-content-start">
                <a href="{{route('user.index')}}" class="btn-pink btn">Back</a>
            </div>
        </div>
                    ...
                    <form action="{{route('user.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control form-control-lg @error('bio') is-invalid @enderror" placeholder="Bio Data" name="bio" cols="30" rows="5">{{old('bio')}}</textarea>
                                @error('bio')
                                <p class='invalid-feedback'>{{$message}}</p>
                                @enderror
                            </div>
